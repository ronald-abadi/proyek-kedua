...
# File: build_push_image_karsajobs_ui.sh
...
echo "---------------------------"
docker images > docker-images-karsajobs-ui-awal.txt
echo "Lihat file docker-images-karsajobs-ui-awal.txt untuk melihat daftar image di lokal"
docker images
echo -e "\n"
...
echo "----------------------------------------"
docker tag karsajobs-ui:latest ronaldabadi/karsajobs-ui:latest
echo -e "\n"
...
echo "--------------------------"
docker push ronaldabadi/karsajobs-ui:latest
echo -e "\n"
...
echo "---------------------------------------------"
export ITEM_APP_IMAGE_ID="$(docker images -q karsajobs-ui:latest)"
docker tag $ITEM_APP_IMAGE_ID ghcr.io/ronald-abadi/karsajobs-ui:latest
echo -e "\n"
...
echo "-------------------------------"
docker push ghcr.io/ronald-abadi/karsajobs-ui:latest
echo -e "\n"
...
echo "---------------------------------------"
docker images > docker-images-karsajobs-ui-akhir.txt
echo "Lihat file docker-images-karsajobs-ui-akhir.txt untuk melihat daftar image di lokal"
docker images
echo "DONE..."
